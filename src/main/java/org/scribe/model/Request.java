...
class Request {
  ...
  void addBody(HttpURLConnection conn, byte[] content) throws IOException {
    ...
    if (conn.getRequestProperty(CONTENT_TYPE) == null) {
      conn.setRequestProperty(CONTENT_TYPE, getRequestContentType());
    }
  ...
  /**
   * Returns the Content-Type of the request. Defaults to {@link Request#DEFAULT_CONTENT_TYPE} if not set
   * 
   * @return Content-Type
   */
  public String getRequestContentType() {
    return requestContentType == null ? DEFAULT_CONTENT_TYPE : requestContentType;
  }
  ...
  /**
   * Sets the Contet-Type of the bidy of the request
   * 
