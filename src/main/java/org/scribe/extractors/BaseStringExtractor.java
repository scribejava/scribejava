...
/**
 * Simple command object that extracts a base string from a {@link org.scribe.model.AbstractRequest}
 *
...
public interface BaseStringExtractor {
    ...
    /**
     * Extracts an url-encoded base string from the {@link org.scribe.model.AbstractRequest}.
     *
