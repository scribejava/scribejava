...
public class RSASha1SignatureServiceTest {
	...
	RSASha1SignatureService service = new RSASha1SignatureService(
			getPrivateKey());
	...
	public void shouldReturnSignature() {
		...
		assertEquals(signature,
				service.getSignature(baseString, apiSecret, tokenSecret));
	}
	 ...
	 * '/C=GB/ST=/L=Manchester/CN=www.example.com' -keyout myrsakey.pem -out
	 * /tmp/myrsacert.pem openssl pkcs8 -in myrsakey.pem -topk8 -nocrypt -out
	 * myrsakey.pk8
	 */
