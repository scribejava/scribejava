...
public class RenrenExample {
	...
	public static void main(String[] args) {
		...
		OAuthService service = new ServiceBuilder().provider(RenrenApi.class)
				.apiKey(apiKey).apiSecret(apiSecret)
				.scope("status_update publish_feed")
				.callback("http://your.doman.com/oauth/renren").build();
		...
		sigString.add(String.format("%s=%s", OAuthConstants.ACCESS_TOKEN,
