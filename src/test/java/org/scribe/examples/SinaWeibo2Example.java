...
{
  private static final String PROTECTED_RESOURCE_URL = "https://api.weibo.com/2/statuses/public_timeline.json?access_token=";
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("=== SinaWeibo2's OAuth Workflow ===");
    System.out.println();
