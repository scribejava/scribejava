package org.scribe.examples.server;
 ...
 * 
 * <p>
 * NanoHTTPD version 1.25, Copyright &copy; 2001,2005-2012 Jarno Elonen (elonen@iki.fi, http://iki.fi/elonen/) and Copyright &copy; 2010 Konstantinos
...
public class NanoHTTPD {
  ...
  protected String createLink(String uri, String filename) {
    return "<a href=\"" + encodeUri(uri + filename) + "\">" + filename + "</a>";
  }
