...
{
  private RequestSync getRequest;
  private RequestSync postRequest;
  ...
  public void setup() throws Exception
  {
    ...
    postRequest = new RequestSync(Verb.POST, "http://example.com");
    ...
    getRequest = new RequestSync(Verb.GET, "http://example.com?qsparam=value&other+param=value+with+spaces");
  ...
  {
    Request request = new RequestSync(Verb.GET, "http://example.com?one=val");
