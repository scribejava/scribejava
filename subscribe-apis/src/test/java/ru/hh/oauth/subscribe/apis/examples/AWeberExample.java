...
import ru.hh.oauth.subscribe.apis.AWeberApi;
...
public class AWeberExample {
    ...
    public static void main(String[] args) {
        ...
        OAuthRequest request = new OAuthRequest(Verb.GET, ACCOUNT_RESOURCE_URL, service);
        ...
        System.out.println();
        System.out.println("Thats it man! Go and build something awesome with AWeber and SubScribe! :)");
    }
