...
public class ArmeriaHttpClientTest extends AbstractClientTest {
    ...
    protected HttpClient createNewClient() {
        ...
        final Function<? super EventLoopGroup, ? extends AddressResolverGroup<? extends InetSocketAddress>> addressResolverGroupFactory = eventLoopGroup -> new MockAddressResolverGroup();
