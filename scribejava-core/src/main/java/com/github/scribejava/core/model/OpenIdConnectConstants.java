...
/**
 * Defines several constants that are used by in <a href="http://openid.net/specs/openid-connect-core-1_0.html">the
 * OpenID connect</a> specifications.
 */
public interface OpenIdConnectConstants {
     ...
     */
    String USERINFO_SIGNING_ALG_VALUES_SUPPORTED = "userinfo_signing_alg_values_supported";
     ...
     */
    String USERINFO_ENCRYPTION_ALG_VALUES_SUPPORTED = "userinfo_encryption_alg_values_supported";

    /**
     * OPTIONAL. JSON array containing a list of the JWE encryption algorithms (enc values) supported by the UserInfo
     * Endpoint to encode the Claims in a JWT.
     */
    String USERINFO_ENCRYPTION_ENC_VALUES_SUPPORTED = "userinfo_encryption_enc_values_supported";
     ...
     * options are client_secret_post, client_secret_basic, client_secret_jwt, and private_jwt, as described in Section
     * 9 of OpenID Connect Core 1.0. Other authentication methods MAY be defined by extensions. If omitted, the default
     * is client_secret_basic -- the HTTP Basic Authentication Scheme specified in Section 2.3.1 of OAuth 2.0.
     */
     ...
     * for the signature on the JWT used to authenticate the Client at the Token Endpoint for the private_jwt and
     ...
     * <p>
     * This property is defined in <a href="http://openid.net/specs/openid-connect-session-1_0.html">the session
     * management</a> specification of OpenID connect and only present iff the OpenID connect provider supports session
     * management.
     * </p>
     */
