...
So this is a little fork of the scribe api (original readme below). I've merged some of the pending pull requests and put it on my own little maven repo so everyone can just include the dependency and be happy.
...
And "here's the maven repository":http://stackmagic.github.com/maven-repo/maven2
