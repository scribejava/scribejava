...
public class Zoho20RevokeExample {
    ...
    public static void main(String... args) throws IOException, InterruptedException, ExecutionException {
        ...
        final OAuth20Service service = new ServiceBuilder(clientId)
                ...
                .defaultScope("AaaServer.profile.READ") // replace with desired scope
        ...
        try(Scanner in = new Scanner(System.in, "UTF-8")){
            ...
            System.out.println();
            System.out.println("Revoking access token...");
            ...
            final OAuth2AccessToken newAccessToken = service.refreshAccessToken(accessToken.getRefreshToken());
            System.out.println("Got the new Access Token!");
            System.out.println("(The raw response looks like this: " + newAccessToken.getRawResponse() + "')");

            accessProtectedResource(service, newAccessToken);

            System.out.println();
            System.out.println("Revoking refresh token...");
            service.revokeToken(accessToken.getRefreshToken());
            System.out.println("done.");
            System.out.println("After revoke we should fail requesting any data...");
            ...
            System.out.println();
            System.out.println(
            "Refreshing access token should also fail now as refresh token has been revoked...");
            try{
    ...
    @SuppressWarnings("PMD.SystemPrintln")
    private static void accessProtectedResource(OAuth20Service service, OAuth2AccessToken accessToken)
